...
<ImageCard
  ...
  key='image01'
  src={image01}
  alt='image of Coding Kittens with navbar occuping a big percentage of the screen'
  width={250}
  height={450}
  caption={{
...
<CodeSandbox files={getFiles({ animationStyles: false })} />
...
/* [!code focus]*/ ... more html code here
```
...
<CodeSandbox files={getFiles({ animationStyles: true })} />
