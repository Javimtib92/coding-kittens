...
¿Cómo te quedarías si te digo que existe una manera futurista de enfocar la solución utilizando exclusivamente CSS? Escogerías la <Pill>[#unstyled píldora aburrida](#less-fun-implementation)</Pill> o la <Pill color="red">[#unstyled píldora futurística](#what-is-the-scroll-css-function-and-scrolltimeline)</Pill>?
...
Tenemos nuestra primera versión de la barra de navegación, similar a la mencionada [al principio de esta entrada del blog](#a-bit-of-context). Aún no hemos añadido la animación y ocupa un gran porcentaje de la pantalla. Lo podemos hacer mejor.
