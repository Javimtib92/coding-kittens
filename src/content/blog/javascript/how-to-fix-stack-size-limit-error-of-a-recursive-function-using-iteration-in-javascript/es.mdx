---
title: 'Como corregir el error "Stack-Size limit" de una función recursiva remplazandola por una iteración en JavaScript'
pubDate: 2024-01-05
thumbnail: ~/assets/thumbnails/abstract.jpeg
subtitle: Recursive who?
shortDescription: >
  Descubre una manera alternativa de travesar un objeto complejo usando iteración en lugar de recursividad para prevenir el error "stack-size limit".
---
...
<Highlight>By the end of this post you will learn how to avoid this situation by converting a recursive function into its iterative counterpart</Highlight>. But first I will give you a small introduction to the recursive approach.
